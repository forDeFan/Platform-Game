...
{   
    ...
    create: function()
    {
        ...
        //enemy
        this.enemy = new Enemy(this.game, 795, 320, 'enemy', 1.4, 8);
        ...
        this.crates = this.map.createFromObjects('Objects', 70, 'crate', 0, true, false, this.crate, Bonus, true, false);
